...
This is the Juan Rosario Portfolio build a Microverse Academy in which we have to replicate the template using Bootstrap. We use pair-programing in this project
...
- Clone the repository by excecuting the git clone ```git@github.com:jrosario19/My-portfolio-Bootstrap.git``` from the terminal.
